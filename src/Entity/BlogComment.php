...
class BlogComment
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\BlogTopic", inversedBy="blogComment", cascade={"persist"})
     * @ORM\JoinColumn(name="topic_id", referencedColumnName="id", nullable=false)
     */
    private $blogTopic;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="blogComment", cascade={"persist"})
