 ...
 */
final class Version20191016085245 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE affiliates_categories (affiliates_id INT NOT NULL, categories_id INT NOT NULL, INDEX IDX_87BE2180F734D5BB (affiliates_id), INDEX IDX_87BE2180A21214B7 (categories_id), PRIMARY KEY(affiliates_id, categories_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE jobs ADD CONSTRAINT FK_A8936DC512469DE2 FOREIGN KEY (category_id) REFERENCES categories (id)');
        $this->addSql('ALTER TABLE affiliates_categories ADD CONSTRAINT FK_87BE2180F734D5BB FOREIGN KEY (affiliates_id) REFERENCES affiliates (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE affiliates_categories ADD CONSTRAINT FK_87BE2180A21214B7 FOREIGN KEY (categories_id) REFERENCES categories (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE affiliates_categories DROP FOREIGN KEY FK_87BE2180A21214B7');
        $this->addSql('ALTER TABLE affiliates_categories DROP FOREIGN KEY FK_87BE2180F734D5BB');
